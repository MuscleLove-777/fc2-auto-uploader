...
# --- タイトルテンプレート ---
# 固有名詞（キャラ名）は使わない。抽象的な表現のみ（ユーザー指示 2026-07-12）。
TITLE_TEMPLATES = [
    "💪 {category}",
    "🔥 {category}、まじやばくない？",
    "✨ {category}、仕上がりが神すぎる",
    "🔥 {category}、バキバキすぎて語彙力ゼロになった",
    "💪 {category}、もちもちなのにバキバキな件",
    "✨ 汗テカテカの{category}、オイル塗ったみたいじゃん笑",
    "🔥 小麦肌×アスリート×{category}。この仕上がりは反則",
    "♡ {category}、破壊力満点",
    "💪 鍛え上げた身体はエロい。{category}",
    "🔥 {category}、汗でフェロモンやばすぎる件",
    "✨ 筋肉美女好きは見逃し厳禁、{category}",
    "♡ ジム帰りの無防備な色気、{category}",
]
...
DESCRIPTION_TEMPLATES = [
    "💪 腹筋バキバキなのにむちむち。この矛盾が最高すぎる♡",
    "🔥 褐色テカテカボディ。汗で仕上がった筋肉美をどうぞ",
    "✨ 鍛え抜かれたワキと腹筋。フェチにはたまらない一枚",
    "💪 小麦肌×アスリート体型。この仕上がりは反則級",
    "🔥 マイクロビキニ級の露出で魅せる筋肉美女",
    "♡ 色白もちもち＋うっすら腹筋。体型の神バランス",
    "✨ 長身グラマラス、大胸筋×爆乳の反則コンボ",
    "💪 汗テカテカでオイル塗ったみたいな質感、神",
    "🔥 筋トレ女子の限界突破ボディ、今日も破壊力満点",
    "♡ ジム帰りの無防備な色気、たまらん",
    "💪 肩幅しっかり、お尻プリッ。アスリート体型の完成形",
    "🔥 ムキムキなのに女性らしい。このバランスが刺さる",
]
