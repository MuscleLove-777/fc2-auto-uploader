...
# --- タイトルテンプレート ---
TITLE_TEMPLATES = [
    "💪 凛花の{category}が今日もバグってる件",
    "🔥 {category} | カイの筋肉、進化しすぎて草",
    "✨ ましろが披露する{category}の新境地♡",
    "💪 {category}で魅せる紫苑のアウトライン🔥",
    "♡ アヤネの{category}、フォロワー騒然の理由",
    "🔥 深夜のジムで撮れた{category}が神すぎた✨",
    "💪 {category} | 脱いだ瞬間、空気が変わった♡",
    "✨ {category}コレクション ～MuscleLove厳選～🔥",
    "🔥 凛花×カイの{category}対決、勝者は…？💪",
    "♡ {category}に隠された努力と汗の物語✨",
    "💪 {category} | 「え、CGじゃないの？」って言われた🔥",
    "✨ ましろの{category}日記 ～増量期のリアル～♡",
    "🔥 褐色肌×{category}の相性が良すぎる問題💪",
    "♡ {category}を極めた女たち | MuscleLove✨",
    "💪 紫苑が語る{category}への執着🔥",
    "✨ {category} | 筋肉フェチ歓喜のアングル♡",
    "🔥 アヤネ流{category}メソッド、ついに公開💪",
    "♡ {category}の裏側 ～トレーニーの本音～✨",
    "💪 凛花の{category}、レベチすぎて言葉出ない🔥",
    "✨ {category} | この仕上がり、何食べたらなれる？♡",
]
...
DESCRIPTION_TEMPLATES = [
    "💪 凛花がオフシーズンに撮った1枚。力抜いててもこの迫力、ズルくない？♡",
    "🔥 カイのベンチプレス自己ベスト更新！胸筋のパンプ具合がエグすぎて声出た",
    "✨ ましろ曰く「今日は軽めに」→フルスクワット120kg。軽めとは…💪",
    "♡ 紫苑のバックポーズ練習風景。広背筋の広がりに息を飲む🔥",
    "💪 アヤネの腹筋ローラー100回チャレンジ。腹斜筋のカットが鬼✨",
    "🔥 減量末期のコンディション。皮一枚の仕上がりに思わず二度見♡",
    "✨ トレ後のパンプショット。筋繊維まで見えそうなこの質感、本物の証💪",
    "♡ ジムの照明で浮かぶ陰影が最高にエモい。筋肉は光と影の芸術🔥",
    "💪 「なんで筋トレするの？」→この写真が全ての答え。見ればわかる✨",
    "🔥 褐色の肌にうっすら浮かぶ血管。鍛え込んだ者だけが手にする勲章♡",
    "✨ 凛花とアヤネの合トレ。2人並ぶとパワーの圧が画面越しでも伝わる💪",
    "♡ 大会直前のカーボアップ完了。筋肉にハリが出て過去最高の仕上がり🔥",
    "💪 「触っていい？」禁止令が出るレベルの筋肉美。見るだけで我慢して✨",
    "🔥 夕暮れのアウトドアトレーニング。自然光×筋肉のコントラストが映える♡",
    "✨ 毎日の積み重ねがこの身体を作った。努力は絶対に裏切らない💪🔥",
]
